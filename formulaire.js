...
if(prenom.value==""){
    ...
    miss_prenom.textContent='Veuillez entrer votre prénom'; /*Pour afficher "prénom manquant", il faut créer une span id dans HTML, 
...
if(nom.value==""){
    ...
    miss_nom.textContent='Veuillez entrer votre nom';
}
...
if(mail.value==""){
    ...
    event.preventDefault(); 
    miss_mail.style.color = 'red'
    miss_mail.textContent='Veuillez entrer une adresse mail valide svp';    
} 

if(mail.value==""){
    event.preventDefault(); 
    miss_mail.style.color ='red'
    miss_mail.textContent='Veuillez entrer votre adresse mail svp';  
}
else if (verif_mail.test(mail.value)==false){
    event.preventDefault(); 
    miss_mail.style.color = 'red'
...
if(confirm_mail.value==""){
    ...
    missconfirm_mail.textContent='Veuillez entrer votre adresse mail de confirmation svp'; 
}
...
if(mdp.value==""){
    ...
    miss_mdp.textContent='Veuillez entrer un mot de passe svp';  
}

if(day.value==""){
    event.preventDefault(); 
    miss_date.style.color ='red'
    miss_date.textContent='Veuillez choisir un jour de naissancesvp';
...
if(month.value==""){
    event.preventDefault(); 
    miss_date.style.color ='red'
    miss_date.textContent='Veuillez choisir un mois de naissance svp';
...
if(year.value==""){
    event.preventDefault(); 
    miss_date.style.color ='red'
    miss_date.textContent='Veuillez votre date de naissance svp';  
}
}
